...
/* ------------------------- populate LED PORT 1 macros ------------------------- */


#define __bsp_NUM_PORT1_DEFINES__  ((defined __bsp_LED_PORT1__)  + \
                                   (defined __bsp_LED_PORT1_DDR__) + \
                                   (defined __bsp_LED_PORT1_IS_ACTIVE_LOW__))

#if (__bsp_NUM_PORT1_DEFINES__ == 3)
#define __bsp_LED_PORT1_TURN_ON__(bit)    __bsp_LED_TURN_ON__ ( bit, __bsp_LED_PORT1__, __bsp_LED_PORT1_DDR__, __bsp_LED_PORT1_IS_ACTIVE_LOW__ )
#define __bsp_LED_PORT1_TURN_OFF__(bit)   __bsp_LED_TURN_OFF__( bit, __bsp_LED_PORT1__, __bsp_LED_PORT1_DDR__, __bsp_LED_PORT1_IS_ACTIVE_LOW__ )
#define __bsp_LED_PORT1_TOGGLE__(bit)     __bsp_LED_TOGGLE__  ( bit, __bsp_LED_PORT1__, __bsp_LED_PORT1_DDR__, __bsp_LED_PORT1_IS_ACTIVE_LOW__ )
#define __bsp_LED_PORT1_IS_ON__(bit)      __bsp_LED_IS_ON__   ( bit, __bsp_LED_PORT1__, __bsp_LED_PORT1_DDR__, __bsp_LED_PORT1_IS_ACTIVE_LOW__ )
#define __bsp_LED_PORT1_CONFIG__(bit)     __bsp_LED_CONFIG__  ( bit, __bsp_LED_PORT1__, __bsp_LED_PORT1_DDR__, __bsp_LED_PORT1_IS_ACTIVE_LOW__ )
#elif (__bsp_NUM_PORT1_DEFINES__ == 0)
#define __bsp_LED_PORT1_TURN_ON__(bit)    /* no LED */
#define __bsp_LED_PORT1_TURN_OFF__(bit)   /* no LED */
#define __bsp_LED_PORT1_TOGGLE__(bit)     /* no LED */
#define __bsp_LED_PORT1_IS_ON__(bit)      /* no LED */  0
#define __bsp_LED_PORT1_CONFIG__(bit)     /* no LED */
#else
#error "ERROR: Incomplete number of macros for PORT1 LED."
#endif
