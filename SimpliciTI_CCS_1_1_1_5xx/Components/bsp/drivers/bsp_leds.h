...
#define BSP_TURN_ON_LED_PORT1(bit)      __bsp_LED_PORT1_TURN_ON__(bit)
#define BSP_TURN_OFF_LED_PORT1(bit)     __bsp_LED_PORT1_TURN_OFF__(bit)
#define BSP_TOGGLE_LED_PORT1(bit)       __bsp_LED_PORT1_TOGGLE__(bit)
#define BSP_LED_IS_ON_PORT1(bit)        __bsp_LED_PORT1_IS_ON__(bit)
