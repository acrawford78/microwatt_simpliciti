 ...
 * ------------------------------------------------------------------------------------------------
 */
 /* board has 8 leds but only 2 configured for use with simpliciti bsp see 5529 HAL_Board.c */
...
#define __bsp_LED1_PORT__           P8OUT
#define __bsp_LED1_DDR__            P8DIR
 ...
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 */
#define __bsp_LED2_BIT__            2
#define __bsp_LED2_PORT__           P8OUT
#define __bsp_LED2_DDR__            P8DIR
