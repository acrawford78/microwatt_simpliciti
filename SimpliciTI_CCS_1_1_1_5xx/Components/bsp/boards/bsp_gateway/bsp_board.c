...
{	
  ...
  #ifdef MICROWATT_ITRV
  //two LED on P7.5, P7.6
  P7OUT |= (BIT6|BIT5);
  #else
  //enable 8 LEDs on PORT1 and PORT4, all have externa1 pull-ups to 3V3
  P1REN = 0;
  P1DIR = 0xFF;
  P1OUT = 0xFF;
  ...
  //P2.2 P2.3 used for GD0 and GD2 now, set as input
  P2DIR = ~(BIT2 | BIT3);
   ...
   P8OUT |= (BIT5);
  #else
  //only set P8.6 P8.6 to enable for power
  P8REN = 0;
  P8DIR = (BIT6 | BIT5);
  P8OUT |= (BIT6 | BIT5);
  #endif
