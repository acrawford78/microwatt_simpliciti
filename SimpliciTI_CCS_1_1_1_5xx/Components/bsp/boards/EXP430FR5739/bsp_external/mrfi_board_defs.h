...
#define __mrfi_GDO0_PORT__                    4
#define MRFI_CONFIG_GDO0_PIN_AS_INPUT()       st( P4SEL0 &= ~BV(__mrfi_GDO0_BIT__); ) /* clear pin special function default */
...
#define MRFI_CONFIG_GDO2_PIN_AS_INPUT()       st( P2SEL0 &= ~BV(__mrfi_GDO2_BIT__); ) /* clear pin special function default */
...
#define MRFI_SPI_IS_INITIALIZED()         (UCB0CTLW0 & UCMST)
